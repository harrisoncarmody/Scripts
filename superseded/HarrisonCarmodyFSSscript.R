...
study<-"Carnarvon Model" # sets name of this workspace

# Add you work dir here-
work.dir=("/Volumes/GoogleDrive/My Drive/Masters_Charlotte/Analysis") # Owncloud
...
dat<-read.csv("C:/Users/21644425/Documents/My Documents//Data/Combined trip data/Boatrampsurveydata.csv",stringsAsFactors =T)%>%
